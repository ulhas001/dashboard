  ...
  return (
    <>
      <div className="container p-5 ">
        <h1 className="text-center">Artist Dashboard </h1>
        {/* modal */}

        <motion.div
          className="d-flex align-items-center justify-content-center text-center mt-5 mb-4 flex-column "
        ...
        <p className="text-center">Add your art here !</p>
        {/* edit profile  */}

        <motion.div
          className="d-flex align-items-center justify-content-center text-center  flex-column mt-5 mb-4"
          whileHover={{ scale: 1.4 }}
          whileTap={{
            scale: 0.8,
                    ...
                    <div>
                      ...
                      <div class="form-floating mb-3">
                        <input
                          ...
                          placeholder="Description"
                        />
                        <label for="floatingInput">Insta </label>
                      </div>
